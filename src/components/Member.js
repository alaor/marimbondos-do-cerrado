...
let Member = ({atleta, selectedAthleteData, loading}) => {
  ...
  const handleStravaClick = (idClient, clientSecret, refreshToken, profileId) => {
    let link = 'https://www.strava.com/oauth/authorize?client_id='+idClient+'&response_type=code&redirect_uri=http://marimbondosdocerrado-uat.netlify.app/?clientSecret='+idClient+'-'+clientSecret+'-'+refreshToken+'-'+profileId+'&approval_prompt=force&scope=activity:read_all,profile:read_all';
